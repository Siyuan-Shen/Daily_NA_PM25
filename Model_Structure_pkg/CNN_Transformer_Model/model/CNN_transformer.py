...
from Model_Structure_pkg.CNN_Transformer_Model.model.encoder import Encoder
from Model_Structure_pkg.CNN_Transformer_Model.model.decoder import Decoder
from Model_Structure_pkg.CNN_Transformer_Model.blocks.resnet_block import resnet_block_embedding,resnet_block_lookup_table
from Model_Structure_pkg.utils import *

class CNN_Transformer(nn.Module):
    def __init__(self, CNN_input_dim,transformer_input_dim, trg_dim,d_model, n_head, ffn_hidden, num_layers, max_len=1000, drop_prob=0.1, device=None):
        ## CNN_input_dim: Dimension of the CNN input features; number of channels
        ## transformer_input_dim: Dimension of the transformer input features; number of channels
        ...
        self.block =  resnet_block_lookup_table(CNN_Transformer_ResNet_Blocks)
        self.transformer_input_dim = transformer_input_dim
        self.Encoder_input_dim = CNN_Transformer_ResNet_output_channels[-1] + transformer_input_dim
